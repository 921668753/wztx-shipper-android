...
import com.ruitukeji.zwbh.adapter.PrepaidPhoneRecordsViewAdapter;
...
public class PrepaidPhoneRecordsActivity extends BaseActivity implements PrepaidPhoneRecordsContract.View, AdapterView.OnItemClickListener, BGARefreshLayout.BGARefreshLayoutDelegate {
    ...
    private PrepaidPhoneRecordsViewAdapter prepaidPhoneRecordsViewAdapter;
    ...
    public void initData() {
        ...
        prepaidPhoneRecordsViewAdapter = new PrepaidPhoneRecordsViewAdapter(this);
    }
    ...
    public void initWidget() {
        ...
        lv_prepaidPhoneRecords.setAdapter(prepaidPhoneRecordsViewAdapter);
...
//        showLoadingDialog(getString(R.string.dataLoad));
    ...
    public void getSuccess(String s) {
        ...
        if (mMorePageNumber == NumericConstants.START_PAGE_NUMBER) {
            mRefreshLayout.endRefreshing();
            prepaidPhoneRecordsViewAdapter.clear();
            prepaidPhoneRecordsViewAdapter.addNewData(prepaidPhoneRecordsBean.getResult().getList());
        } else {
            mRefreshLayout.endLoadingMore();
            prepaidPhoneRecordsViewAdapter.addMoreData(prepaidPhoneRecordsBean.getResult().getList());
        }
    ...
    protected void onDestroy() {
        super.onDestroy();
        prepaidPhoneRecordsViewAdapter.clear();
        prepaidPhoneRecordsViewAdapter = null;
    }
}
