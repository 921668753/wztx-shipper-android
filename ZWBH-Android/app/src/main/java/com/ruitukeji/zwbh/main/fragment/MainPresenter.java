...
public class MainPresenter implements com.ruitukeji.zwbh.main.MainContract.Presenter {

    private com.ruitukeji.zwbh.main.MainContract.View mView;
    ...
    public void setupLocationStyle(AMap aMap) {
        ...
        myLocationStyle.myLocationIcon(BitmapDescriptorFactory.fromResource(R.mipmap.icon_pin));// 设置小蓝点的图标
