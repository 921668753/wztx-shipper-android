 ...
 */
public class IntercityFragment extends BaseFragment implements EasyPermissions.PermissionCallbacks, MainFragmentContract.View, GeocodeSearch.OnGeocodeSearchListener, LocationSource, AMapLocationListener, AMap.OnCameraChangeListener, CloudSearch.OnCloudSearchListener {
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_enterDestination:
                ...
                ((MainFragmentContract.Presenter) mPresenter).startActivityForResult(this, isDestination, isOff1, type, tran_type, destinationLat,
                        ...
                        destinationShipper, destinationPhone, destinationEixedTelephone, REQUEST_CODE_PREVIEW, startCity);
                break;
