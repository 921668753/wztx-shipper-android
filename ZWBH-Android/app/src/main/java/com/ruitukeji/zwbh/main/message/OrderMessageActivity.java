...
import com.ruitukeji.zwbh.adapter.main.message.OrderMessageViewAdapter;
...
public class OrderMessageActivity extends BaseActivity implements OrderMessageContract.View, AbsListView.OnScrollListener, AdapterView.OnItemClickListener, BGAOnItemChildClickListener, BGARefreshLayout.BGARefreshLayoutDelegate {
...
//    private TextView tv_orderMessage1;
    ...
    @BindView(id = R.id.lv_orderMessage)
    ...
    private String push_type = "order";
    ...
    private OrderMessageViewAdapter mAdapter;
    ...
    public void initData() {
        super.initData();
        mPresenter = new OrderMessagePresenter(this);
        mAdapter = new OrderMessageViewAdapter(this);
...
//                showActivity(aty, intent);
        ...
        lv_orderMessage.setAdapter(mAdapter);
        lv_orderMessage.setOnItemClickListener(this);
        mAdapter.setOnItemChildClickListener(this);
        lv_orderMessage.setOnScrollListener(this);
    ...
    @Override
    public void setPresenter(OrderMessageContract.Presenter presenter) {
